...
const Prompt = ({ isOpen, closeModal, title }) => {
    ...
    return (jsx("div", { className: backdropStyle, ref: modalRef, style: {
            display: isOpen ? "flex" : "none",
        }, children: jsx("div", { className: dialogContentStyle, children: jsxs("div", { className: "flex flex-row justify-start gap-1 items-center", children: [jsx("div", { children: jsx(Success, {}) }), jsx("div", { className: "text-green-100 font-semibold text-xl", children: title })] }) }) }));
};
