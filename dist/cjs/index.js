...
const Button = React.forwardRef(({ children, icon, text = "", variant = "primary", className = "", direction = "ltr", weight = "normal", active = false, hasIcon = false, loading = false, // Default loading state
...
colorVariant, fullWidth = false, ...props }, ref) => {
    ...
    return (React.createElement("button", { ref: ref, "data-variant": variant, "data-active": active, "data-color-variant": colorVariant, "aria-busy": loading, style: { ...mergedStyle }, disabled: props.disabled, className: `btn dir-${direction} ${iconClass} aui-btn-${variant} ${fontWeightClass} ${className} ${loading ? "loading" : ""}`, ...props }, loading ? (React.createElement(React.Fragment, null,
        loader || React.createElement("span", { className: "default-loader" }),
        children || text)) : (React.createElement(React.Fragment, null,
        icon && React.createElement("i", { className: `${getIconClass()}` }),
        children || text))));
});
...
const SearchBar = ({ value, onChange, handleSearch, }) => {
    ...
    return (React.createElement("form", { className: `search-container ${isFocused ? "focused" : ""}`, onSubmit: (e) => {
            e.preventDefault();
            handleSearch();
        }, role: "search" },
        React.createElement("input", { value: value ?? "", type: "search", className: "search-input", placeholder: "Search", onChange: (e) => {
                onChange(e);
            }, onFocus: handleFocus, onBlur: handleBlur, role: "searchbox", "aria-label": "Search" }),
        React.createElement("button", { className: "search-button", type: "submit" },
...
const Input = ({ isError, placeholder, onChange, onBlur, onFocus, type = "text", value, errorMsg, name, required = false, readOnly = false, disabled = false, prefix, suffix, style, ...props }) => {
    ...
    React.createElement("div", { className: "input-wrapper" },
        React.createElement("div", { className: `input-container ${isFocused ? "focused" : ""} ${isError ? "error" : ""} ${disabled ? "disabled" : ""}`, style: style?.container },
            prefix && React.createElement("span", null, prefix),
            React.createElement("input", { type: type, disabled: disabled, readOnly: readOnly ?? undefined, required: required, value: value, name: name ?? undefined, id: "exampleInput", className: `${isError ? "is-invalid" : ""}`, placeholder: placeholder ?? "", onChange: (e) => onChange(e), onFocus: handleFocus, onBlur: handleBlur, style: style?.input, pattern: type === "number" ? "[0-9]*" : "", inputMode: type === "number" ? "decimal" : "text", ...props }),
...
const Accordion = ({ title, children, styles }) => {
    ...
    return (React.createElement("div", { className: "accordion-container", style: styles?.container },
        React.createElement("div", { className: "accordion-title-container", onClick: handleCollapse, style: styles?.header },
            React.createElement("div", null, title),
            React.createElement(motion.div, { initial: "collapsed", exit: "collapsed", animate: { rotate: showChild ? 180 : 0 }, className: "accordion-button", transition: { duration: 0.2 } },
                React.createElement("button", { onClick: handleCollapse },
                    React.createElement("i", { className: "ri-arrow-down-line" })))),
        React.createElement(AnimatePresence, null, showChild ? (React.createElement(motion.div, { initial: { height: 0, opacity: 0 }, animate: { height: "auto", opacity: 1 }, exit: {
                opacity: 0,
                height: 0,
            }, transition: { duration: 0.1, ease: "easeInOut" }, className: "container" },
            React.createElement("div", { style: { borderRadius: "0 0 4px 4px", ...styles?.body } },
                " ",
