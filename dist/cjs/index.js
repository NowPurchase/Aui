...
const Button = ({ children, variant = "primary", disabled = false, onClick, type, style, }) => {
    return (React.createElement("button", { disabled: disabled, className: `btn ${variant}`, onClick: onClick, type: type ?? "button", style: style }, children));
};
...
const Accordion = ({ title, children, styles }) => {
    ...
    return (React.createElement("div", { className: "accordion-container", style: styles?.container },
        ...
        React.createElement("div", null, showChild && (React.createElement(motion.div, { initial: { height: 0, opacity: 0 }, animate: { height: "auto", opacity: 1 }, exit: {
                opacity: 0,
                height: 0,
