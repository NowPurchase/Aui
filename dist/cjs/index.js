...
const Input = ({ isError, placeholder, onChange, label, value, errorTxt, name, required = false, }) => {
    return (React.createElement("div", { className: "form-group" },
        label && React.createElement("label", { htmlFor: "exampleInput" }, label),
        React.createElement("input", { required: required, value: value, name: name ?? undefined, type: "text", id: "exampleInput", className: isError ? "is-invalid" : "", placeholder: placeholder ?? "", onChange: (e) => onChange(e) }),
